    ...
    return (
        <div
            ...
            <button type="button"
                    ...
                    className={`${(hasHintRight && !isGameCompleted) ? "bg-purple-500 hover:bg-purple-600" : "bg-purple-400 text-purple-100 cursor-auto"} flex items-center justify-center gap-3 px-5 py-1 rounded-md shadow transition-all  truncate`}>
                <span>Give A Hint</span>
            </button>

            <button type="button"
                    onClick={handleShowAnswer}
                    className={`${isGameCompleted ? "bg-purple-400 text-purple-100 cursor-auto" : "bg-purple-500 hover:bg-purple-600"} "flex items-center justify-center gap-3 px-5 py-1 rounded-md shadow transition-all truncate"`}>
                <span>Answer</span>
            </button>
