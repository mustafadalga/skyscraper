...
import NoGamesForFilter from "./NoGamesForFilter";
import { TimeFrame } from "@/(app)/_enums";
import GameList from "./GameList";
import FilterGroup from "./FilterGroup";
const ModalGame = dynamic(() => import("@/(app)/_components/modals/ModalGame"), { ssr: false })
const ModalCopySharedChallenge = dynamic(() => import("@/(app)/_components/modals/ModalCopySharedChallenge"), { ssr: false })
